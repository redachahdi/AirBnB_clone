#!/usr/bin/python3
"""that Defines the FileStorage of the
class."""
import json
...
class FileStorage:
    """Defines an abstract storage engine.
Attributes:
- _file_path (str): The filename for storing objects.
- _objects (dict): A dictionary containing instantiated objects.
    ...
    def all(self):
        """that Returns the dictionary of the objects."""
        return FileStorage._objects

    def new(self, obj):
        """Adds obj to _objects with 
        keys"""
